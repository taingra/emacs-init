...
I previously tried the included mpd client mpc.el, but bounced off the
rhythmbox-inspired UI, poor playlist support, and multiple windows.  I
tend to dislike any Emacs app that starts messing with my window setup
